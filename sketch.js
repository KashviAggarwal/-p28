...
function showArrows (index, playerArrows){
  ...
  if(
    playerArrows[index].body.position.x > width ||
    playerArrows[index].body.position.y > height
  ){
    if(! playerArrows[index].isRemoved){
      playerArrows[index].isRemoved(index,playerArrows);
    }else {
      playerArrows[index].trajectory = []
      }
    }
  }
